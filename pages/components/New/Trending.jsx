...
function Trending() {
  return (
    <Box className="mt-2">
      ...
      <Box className="mx-2 mt-10">


        <Grid container>
          <Grid item lg={6} className='mx-2'>

            <Box className='w-[20rem] flex md:my-10 lg:my-14 mx-10 md:mx-20 lg:mx-52 rounded-lg'>
          ...
          <Grid item lg={6} className='mx-2'>
            ...
            <Box className='w-[20rem] flex flex-row   md:my-10 lg:my-14 mx-10 md:mx-20 lg:mx-52 rounded-lg'>
              <img className='w-[400px] h-[200px]' src='/img/book1.png' />
              <Box sx={{ borderRight: 1, borderBottom: 1, borderTop: 1 }} className='mx-2'>
                <h2 className='text-2xl font-bold'>Book Title</h2>
                <p>Consectetur deserunt veniam proident minim do incididunt in sit officia anim cillum exercitation.</p>
          ...
          <Grid item lg={6} className='mx-2'>
            ...
            <Box className='w-[20rem] flex   md:my-10 lg:my-14 md:mx-20 lg:mx-52 rounded-lg'>
              <img className='w-[400px] h-[200px]' src='/img/book1.png' />
              <Box sx={{ borderRight: 1, borderBottom: 1, borderTop: 1 }} className='mx-2 shadow-2xl'>
                <h2 className='text-2xl font-bold'>Book Title</h2>
                <p>Consectetur deserunt veniam proident minim do incididunt in sit officia anim cillum exercitation.</p>
                <Box className='flex mx-2 text-sky-600'>
                  <Button>Read More</Button>
